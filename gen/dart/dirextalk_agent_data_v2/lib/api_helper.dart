...
String parameterToString(dynamic value) {
  ...
  if (value is AgentDataScope) {
    return AgentDataScopeTypeTransformer().encode(value).toString();
  }
  if (value is ErrorCategory) {
    return ErrorCategoryTypeTransformer().encode(value).toString();
  }
  if (value is OperationState) {
    return OperationStateTypeTransformer().encode(value).toString();
  }
  if (value is RuntimeComponent) {
    return RuntimeComponentTypeTransformer().encode(value).toString();
  }
